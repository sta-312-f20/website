...
* Step (1): Fit a your linear model and calculate the F-statistic for your hypothesis of interest
* Step (2): _Shuffle the responses_ of your outcome variable so they are random and re-fit your linear model. Calculate an F-statistic for your hypothesis of interest for this new model
* Step (3): Repeat step 2 several times and save your F-statistic each time
* Step (4): Compare your F-statistic from step (1) to those generated in step (3). Calculate the proportion of F-statistics calculated in Step 3 that are as extreme or more extreme than the one calculated in step (1).
...
8. Compute 90% and 95% _bootstrap_ confidence intervals for the predictor body weight. How do these compare to those calculated in Exercise 7?
