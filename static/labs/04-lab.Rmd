...
9. Using the model fit in Exercise 2, repeat the prediction for a male with maximal values (for this data) of status, income and verbal score. Which CI is wider and why is this result expected?
...
11. Repeat the prediction for the model in Exercise 10 for a female with status = 20, income = 1, verbal = 10. Comment on the credibility of the result.
